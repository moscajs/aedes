...
class Client {
  ...
  rejectPacketTooLarge (size, done) {
    // Latch so the read loop stops feeding further chunks of a multi-chunk
    // oversized body: nextBatch checks this flag and returns before re-reading,
    // so this method is only entered once per offending frame.
