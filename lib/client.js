...
class Client {
  ...
  // connection is dropped via an observable connectionError/clientError rather
  // than a silent close. [MQTT-3.2.2-15]
  rejectPacketTooLarge (done) {
    if (this.version === 5 && this.connected && !this.closed && !this.errored) {
