...
MemoryPersistence.prototype.outgoingUpdateMessageId = function(clientId, packet, cb) {
  var i
    , outgoing = this._outgoing[clientId] || []
    , temp
...
MemoryPersistence.prototype.outgoingClearMessageId = function(clientId, packet, cb) {
  var i
    , outgoing = this._outgoing[clientId] || []
    , temp
