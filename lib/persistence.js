...
MemoryPersistence.prototype.putWill = function (broker, client, packet, cb) {
  packet.brokerId = broker.id
...
MemoryPersistence.prototype.streamWill = function () {
  var clients = Object.keys(this._wills)
  var wills = this._wills
  return from2.obj(function match (size, next) {
    var entry = clients.shift()
